...
<script>
// @ is an alias to /src
import HeaderQueen from '@/components/HeaderQueen.vue'
import FooterQueen from '@/components/FooterQueen.vue'
import RelatedQueen from '@/components/RelatedQueen.vue'
